...
private:
	...
	GLfloat m_lowestModelY;
	GLfloat m_maxUVX = 0.0f;
	GLfloat m_maxUVY = 0.0f;
	...
	std::vector<comp308::vec3> m_faceNormals;	// Normal list
	...
	GLuint m_displayListWireFloor = 0; // DisplayList for Wireframe
...
public:
	...
	void renderGeometry();
	void renderGeometryUV();
	void toggleWireFrame();
	GLfloat getLowestModelY();
